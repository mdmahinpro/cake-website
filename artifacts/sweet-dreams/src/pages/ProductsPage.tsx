        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          {filtered.length === 0 ? (
            <div className="text-center py-24">
              ...
              <p className="font-playfair text-2xl text-white mb-2">No items here yet</p>
              <p className="text-caramel-400 text-sm">Check back soon or browse another category</p>
            </div>
          ) : (
              ...
              {filtered.map((product, i) => (
                <AnimatedSection key={product.id} delay={i * 60}>
                  <motion.div
                    ...
                    whileHover={{
                      y: -6,
                      boxShadow: `0 20px 48px rgba(0,0,0,0.5), 0 0 30px rgba(${tokens.accentRgb},0.1)`,
                    }}
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col gap-3 flex-1">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-caramel-300 leading-relaxed line-clamp-2 font-poppins">
                          {product.caption}
                        </p>
                      </div>
